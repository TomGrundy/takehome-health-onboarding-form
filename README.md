...
- One of the tests is hitting an warning (not a like hard breaking issue) with it's mock of localstorage that I ran out of time to resolve, which isn't ideal.
